...
- **Reusable pattern for other polyhedra:** adding cube/octahedron/etc. = create a `PolyhedronDefinition` file + register it in `POLYHEDRON_DEFINITIONS` (Task 4). No component or App changes. ✔
