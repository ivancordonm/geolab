...
function ObjectMenu({ object, x, y, onClose, onSetLabel, onSetColor, onSetStyle, onDelete, ref }: ObjectMenuProps) {
  ...
  // Recalcular posición cuando el contenido cambia de tamaño.
  useLayoutEffect(() => {
      ...
      {onSetColor !== undefined && (
        <div className="mb-3">
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {/* El input permanece clicable: un input display:none no abre el diálogo nativo en todos los navegadores. */}
            <div
