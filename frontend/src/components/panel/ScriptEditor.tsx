  ...
  return (
    <section className="p-4" aria-labelledby="script-heading">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <button
          type="button"
          title={t("scriptEditor.clear")}
          aria-label={t("scriptEditor.clear")}
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {running ? t("scriptEditor.running") : t("scriptEditor.run")}
        </button>
      </form>
        ...
        {error ? (
          <>
            <strong className="block">
              {t("scriptEditor.errorLocation", { line: error.line, column: error.column, message: error.message })}
            </strong>
          ...
          (output ?? t("scriptEditor.emptyOutput"))
        )}
      </div>
    </section>
  );
